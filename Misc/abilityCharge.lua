...
local hudElement = Sprite.load("Graphics/UI/skillCharge", 2, 9, 8)
...
Ability.AddCharge = function(player, slot, increment, noDelay)
    ...
    p[maxChargeVars[slot]] = p[maxChargeVars[slot]] + increment
    if noDelay then
        p[chargeVars[slot]] = p[chargeVars[slot]] + increment
    end
end
