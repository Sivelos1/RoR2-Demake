...
local altarLocations = {
    -- Desolate Forest
    [Room.find("1_1_1", "vanilla")] = {x = 2219, y = 1034},
    [Room.find("1_1_2", "vanilla")] = {x = 3289, y = 810},
    [Room.find("1_1_3", "vanilla")] = {x = 4735, y = 874},
    -- Dried Lake
    [Room.find("1_2_1", "vanilla")] = {x = 3759, y = 186},
    [Room.find("1_2_2", "vanilla")] = {x = 39, y = 586},
    [Room.find("1_2_3", "vanilla")] = {x = 2895, y = 953},
    -- Damp Caverns
    [Room.find("2_1_1", "vanilla")] = {x = 3259, y = 1384},
    [Room.find("2_1_2", "vanilla")] = {x = 3044, y = 553},
    -- Sky Meadow
    [Room.find("2_2_1", "vanilla")] = {x = 257, y = 250},
    [Room.find("2_2_2", "vanilla")] = {x = 3255, y = 297},
    -- Ancient Valley
    [Room.find("3_1_1", "vanilla")] = {x = 961, y = 3370},
    [Room.find("3_1_2", "vanilla")] = {x = 801, y = 1130},
    -- Sunken Tombs
    [Room.find("3_2_1", "vanilla")] = {x = 128, y = 1066},
    [Room.find("3_2_2", "vanilla")] = {x = 1050, y = 1610},
    -- Magma Barracks
    [Room.find("4_1_1", "vanilla")] = {x = 1673, y = 1242},
    [Room.find("4_1_2", "vanilla")] = {x = 1975, y = 762},
    -- Hive Cluster
    [Room.find("4_2_1", "vanilla")] = {x = 3172, y = 666},
    [Room.find("4_2_2", "vanilla")] = {x = 100, y = 394},
    -- Temple of the Elders
    [Room.find("5_1_1", "vanilla")] = {x = 3179, y = 1162},
    [Room.find("5_1_2", "vanilla")] = {x = 149, y = 1722},
}
    ...
    if self.active == 0 then --awaiting input
        ...
        if nearest and nearest:isValid() then
            if this:collidesWith(nearest, this.x, this.y) then
                data.showText = true
                if type(nearest) ~= "PlayerInstance" then return end
...
callback.register("onStageEntry", function()
    ...
    if room and altarLocations[room] then
        newtAltar:create(altarLocations[room].x, altarLocations[room].y)
    end
end)
    ...
    for _, body in ipairs(corpse:findAll()) do
        ...
        if nearest and nearest:get("eradicate") and nearest:get("eradicate") > 0 then
            if not b.obliterated then
                ...
                b.death_message = obliterationMessages[math.random(#obliterationMessages - 1)]
                b.obliterated = 1
            end
        end
    end
