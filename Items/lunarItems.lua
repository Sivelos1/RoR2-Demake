...
transcendence:addCallback("pickup", function(player)
    ...
    player:set("percent_hp", (1 / player:get("maxhp_base")))
...
--Focused Convergence--
local convergence = Item.new("Focused Convergence")
convergence.pickupText = "Limits the teleporter charge area, but decreases teleporter charge time."
convergence.sprite = Sprite.load("Items/convergence", 1, 16, 16)
convergence.color = LunarColor
convergence:setLog{
	group = "end",
	description = "Limits the area in which the teleporter can charge, but decreases teleporter charge time.",
    priority = "&b&Unaccounted For&!&",
	story = "---",
	destination = "---,\n---,\n---",
	date = "--/--/2056"
}
Lunar.register(convergence)
